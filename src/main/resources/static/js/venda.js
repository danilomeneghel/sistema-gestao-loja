    ...
    var dataTable = $('#data-table').DataTable({
        ...
        buttons: [
            {
                ...
                title: function () { return 'Gestão de Loja - Vendas'; },
                exportOptions: {
        ...
        initComplete: function() {
            ...
            $('#data-table_length').each(function () {
                $(this).append('<a class="btn btn-success btn-add" href="/venda/cadastro">' +
        ...
        columns: [
            ...
            },
            {
                "data": null, "render": function ( data ) {
                    return '<div class="actions"><a class="btn btn-success" href="/venda/visualizar/'+data.id+'">'+
                    '<i class="fas fa-eye"></i> Ver</a>'+
                    '<a class="btn btn-primary" href="/venda/editar/'+data.id+'">'+
                    '<i class="fas fa-pen"></i> Editar</a><a class="btn btn-danger" '+
                    'onclick="return confirm(\'Tem certeza que deseja excluir esse registro?\');" '+
                    'href="/venda/excluir/'+data.id+'"><i class="fas fa-trash"></i> Excluir</a></div>'
                }
            }
        ],
        language: {
