$(document).ready(function () {
    dataTable = $('#data-table').DataTable({
        ...
        buttons: [
            {
                ...
                title: function () { return 'Gestão de Loja - Fornecedores'; },
                exportOptions: {
        ...
        ajax: {
            url: '/api/fornecedor/fornecedores',
            type: 'GET',
            datatype: 'json',
            dataSrc: ''
        },
        ...
        columns: [
            ...
            },
            {
                "data": null, "render": function (data) {
                    return '<div class="actions"><a class="btn btn-primary" href="/fornecedor/editar/'+data.id+'">'+
                    '<i class="fas fa-pen"></i> Editar</a><a class="btn btn-danger" '+
                    'onclick="return confirm(\'Tem certeza que deseja excluir esse registro?\');" '+
                    'href="/fornecedor/excluir/'+data.id+'"><i class="fas fa-trash"></i> Excluir</a></div>'
                }
            }
        ],
        language: {
